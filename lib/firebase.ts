...
const firebaseConfig = {
  ...
  // authDomain MUST be the Firebase default — custom domain auth proxy only works with
  // Firebase Hosting. Since keyoon.com runs on Vercel/Namecheap hosting, we must use
  // the Firebase domain for the OAuth handler. Users see it for ~1s during redirect.
  authDomain: "rflix-91ab8.firebaseapp.com",
