...
export const BrandTicker: React.FC = () => {
  const brandList = [
    {
      name: 'OpenAI',
      logo: (
        <svg className="h-7 sm:h-8 w-auto text-zinc-300 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
      name: 'Netflix',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24" fill="#E50914">
    ...
    },
    {
      name: 'Claude',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24" fill="#D97706">
    ...
    },
    {
      name: 'Google Gemini',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24">
          <path
            fill="#EA4335"
    ...
    },
    {
      name: 'Spotify',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24" fill="#1ED760">
    ...
    },
    {
      name: 'YouTube',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24" fill="#FF0000">
    ...
    },
    {
      name: 'Adobe',
      logo: (
        <svg className="h-6.5 sm:h-7.5 w-auto" viewBox="0 0 24 24" fill="#FF0000">
    ...
    },
    {
      name: 'Cursor',
      logo: (
        <div className="h-7 sm:h-8 w-7 sm:w-8 rounded-xl bg-zinc-900 border border-zinc-700/80 flex items-center justify-center font-mono font-black text-sm text-cyan-400">
          ⌥
        </div>
      ),
    },
    {
      name: 'NordVPN',
      logo: (
        <svg className="h-7 sm:h-8 w-auto" viewBox="0 0 24 24" fill="#4687FF">
  ...
  return (
    <div className="relative overflow-hidden py-4 bg-transparent">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-28 bg-gradient-to-r from-zinc-950 to-transparent z-10" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-28 bg-gradient-to-l from-zinc-950 to-transparent z-10" />

      {/* Prominent Large Floating Brand Marquee */}
      <div className="overflow-hidden select-none">
        <div className="animate-marquee gap-16 sm:gap-24 items-center">
          {marqueeItems.map((brand, idx) => (
            <div
              key={idx}
              className="flex items-center gap-3.5 text-zinc-400 hover:text-white transition-all hover:scale-110 shrink-0 cursor-pointer group py-1.5"
            >
