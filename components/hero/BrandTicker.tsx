...
export const BrandTicker: React.FC = () => {
  const brandList = [
    {
      name: 'OpenAI',
      badge: 'GPT-4o & Canvas',
      color: 'hover:border-cyan-500/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.25)]',
      logo: (
    ...
    },
    {
      name: 'Netflix 4K',
      badge: 'Dolby Atmos',
      color: 'hover:border-red-500/50 hover:shadow-[0_0_20px_rgba(239,68,68,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#E50914">
    ...
    },
    {
      name: 'Claude 3.5 Pro',
      badge: 'Anthropic AI',
      color: 'hover:border-amber-500/50 hover:shadow-[0_0_20px_rgba(245,158,11,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#D97706">
    ...
    },
    {
      name: 'Google Gemini',
      badge: 'Advanced 2.0',
      color: 'hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.25)]',
      logo: (
    ...
    },
    {
      ...
      badge: 'Lossless Hi-Fi',
      color: 'hover:border-emerald-500/50 hover:shadow-[0_0_20px_rgba(16,185,129,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#1ED760">
    ...
    },
    {
      ...
      color: 'hover:border-red-500/50 hover:shadow-[0_0_20px_rgba(239,68,68,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#FF0000">
    ...
    {
      name: 'Adobe Creative',
      badge: 'All Apps Cloud',
      color: 'hover:border-rose-500/50 hover:shadow-[0_0_20px_rgba(244,63,94,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#FF0000">
    ...
    },
    {
      ...
      color: 'hover:border-cyan-500/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.25)]',
      logo: (
        <div className="h-6 w-6 rounded-lg bg-zinc-900 border border-zinc-700/80 flex items-center justify-center font-mono font-bold text-xs text-cyan-400">
          ⌘
        </div>
      ),
    },
    {
      ...
      color: 'hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.25)]',
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 24 24" fill="#4687FF">
  ...
  // Double array for seamless 360-degree endless loop
  const marqueeItems = [...brandList, ...brandList];

  return (
    <div className="relative overflow-hidden py-4 px-4 rounded-3xl bg-zinc-900/80 border border-zinc-800/80 backdrop-blur-2xl shadow-2xl">
      
      {/* Left & Right Smooth Edge Fade Masks */}
      <div className="pointer-events-none absolute inset-y-0 left-0 w-28 bg-gradient-to-r from-zinc-900 via-zinc-900/80 to-transparent z-10" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-28 bg-gradient-to-l from-zinc-900 via-zinc-900/80 to-transparent z-10" />

      <div className="flex items-center gap-6">
        
        {/* Left Live Pulse Badge */}
        <div className="hidden sm:flex items-center gap-3 shrink-0 z-20 pr-5 border-r border-zinc-800">
          ...
          <div className="text-left">
            <p className="text-xs font-black text-white tracking-wider uppercase font-mono">
              Live Bot Pool
            </p>
            <p className="text-[11px] text-zinc-400 font-mono">&lt; 30s Provisioning</p>
          </div>
        </div>
        ...
        <div className="overflow-hidden flex-1 select-none">
          <div className="animate-marquee gap-5 items-center">
            {marqueeItems.map((brand, idx) => (
              <div
                key={idx}
                className={`flex items-center gap-3.5 px-4 py-2.5 rounded-2xl bg-zinc-950/80 border border-zinc-800/90 text-zinc-300 hover:text-white transition-all duration-300 hover:scale-105 shrink-0 cursor-pointer group shadow-lg ${brand.color}`}
              >
                <div className="group-hover:scale-110 transition-transform shrink-0">
                  {brand.logo}
                </div>
                <div className="text-left">
                  <span className="text-xs font-black tracking-wide text-zinc-100 block group-hover:text-white transition-colors">
                    {brand.name}
                  </span>
                  <span className="text-[10px] font-mono text-zinc-400 block tracking-tight uppercase">
                    {brand.badge}
                  </span>
                </div>
              </div>
        ...
        <div className="hidden lg:flex items-center gap-2.5 shrink-0 z-20 pl-5 border-l border-zinc-800">
          <div className="flex h-7 w-7 items-center justify-center rounded-xl bg-cyan-950/60 border border-cyan-500/30 text-cyan-400">
            <ShieldCheck className="h-4 w-4" />
          </div>
          <div className="text-left">
            <span className="text-xs font-black text-zinc-200 uppercase tracking-wider font-mono block">
              100% Guaranteed
            </span>
            <span className="text-[10px] text-zinc-400 font-mono block">Active Term Replacement</span>
          </div>
        </div>
